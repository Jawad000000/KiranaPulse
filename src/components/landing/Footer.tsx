      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-t border-[var(--color-primary)]/10 pt-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="/contact" className="text-[var(--color-accent)] hover:text-[var(--color-primary)] transition-colors font-bold tracking-widest uppercase text-xs">Contact Me</Link>
          </div>
